...
enum GetAllImpl {
    static func handle(call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        // androidRequiredDataMimetypes / androidRequiredAccountTypes: Android-only
        // filters, ignored here. The Dart layer forwards them unconditionally; the
        // platform name prefix makes the platform scope explicit at the call site.
